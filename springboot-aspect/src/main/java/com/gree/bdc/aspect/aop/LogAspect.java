package com.gree.bdc.aspect.aop;

import com.alibaba.fastjson.JSON;
import com.gree.bdc.aspect.annotation.OperationLogDetail;
import com.gree.bdc.aspect.entity.OperationLog;
...
public class LogAspect {
     ...
     * 此处的切点是注解的方式
     */
    @Pointcut("@annotation(com.gree.bdc.aspect.annotation.OperationLogDetail)")
    ...
    public void daAfterReturning(Object ret){
